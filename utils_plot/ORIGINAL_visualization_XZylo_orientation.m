function visualization_XZylo_orientation
    % --- Initial Setup ---
    [params,~] = xzylo();
    ...
    % --- 1. CYLINDER GEOMETRY DEFINITION ---
    ...
    % --- 2. SLIDERS SETUP (UI CONTROLS) - Bottom-Left Corner ---
    ...
    % --- 3. INITIAL FORCE ARROWS ---
    
    % Gravity (Green) 
    h_grav = quiver3(h_ax, 0, 0, 0, 0, 0, -params.m*params.g/force_scale, 'g', 'LineWidth', 2, 'MaxHeadSize', 0.5,'AutoScale', 'off');
    % Lift (Red)
    ...
    % --- 4. FIXED WIND ARROWS (Wall of Blue Arrows) ---
    ...
    % --- 5. UPDATE FUNCTION (Main Visualization Logic) ---
    ...
    function updateVisualization(~, ~)
        ...
        G_inertial = [0, 0, -params.m*params.g]; 
        ...
        Lift_mag = params.CL(alpha_rad);
        Side_force_mag = params.CL(beta_rad);          
        Drag_mag = params.CD(theta_total_rad);
